...
import (
	...
	mockdb "github.com/tijanadmi/simplebank/db/mock"
...
func TestGetAccountAPI(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			setupAuth: func(t *testing.T, request *http.Request, tokenMaker token.Maker) {
				addAuthorization(t, request, tokenMaker, authorizationTypeBearer, user.Username, "depositor"/*user.Role*/, time.Minute)
			},
			buildStubs: func(store *mockdb.MockStore) {
				store.EXPECT().
